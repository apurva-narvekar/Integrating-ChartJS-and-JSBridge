...
namespace ChartJS
{
	public partial class PieController : UIViewController
	{
		public PieController (IntPtr handle) : base (handle)
		{
		}
        public override void ViewDidLoad()
        {
            ...
            string filePath = NSBundle.MainBundle.PathForResource("web/html/PieChart", "html");
