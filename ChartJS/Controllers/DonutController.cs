...
namespace ChartJS
{
	public partial class DonutController : UIViewController
	{
		public DonutController (IntPtr handle) : base (handle)
		{
		}
        public override void ViewDidLoad()
        {
            ...
            string filePath = NSBundle.MainBundle.PathForResource("web/html/DonutChart", "html");
